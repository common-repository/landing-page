...
function ulpb_register_feed_post_type() {
	...
	$labels = array(
		'name'                => __( 'Landing Pages by Page Builder', 'pbp-ps-cpt' ),
		'singular_name'       => __( 'Landing Page Builder', 'pbp-ps-cpt' ),
		'all_items'       	  => __( 'Landing Pages', 'pbp-ps-cpt' ),
	...
	$args = array(
		...
		'menu_position'       => null,
		'menu_icon'           => LAULPB_PLUGIN_URL.'/images/dashboard/page-builder-templates-icon.png',
...
function wssf_admin_scripts( ) {
	...
	wp_enqueue_script( 'wssf-backbone-builder-jqueryUI', LAULPB_PLUGIN_URL.'/js/Backbone-resources/jquery-ui.js', array( 'jquery' ), false, false );
	wp_enqueue_script( 'wssf-backbone-builder-collectionView', LAULPB_PLUGIN_URL.'/js/Backbone-resources/backbone.collectionView.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-pbb-model-1', LAULPB_PLUGIN_URL.'/admin/scripts/pbb-model-1.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-pbb-model-2', LAULPB_PLUGIN_URL.'/admin/scripts/pbb-model-2.js', array( 'jquery' ), false, true );
	
	wp_enqueue_script( 'wssf-backbone-builder-script-bb3', LAULPB_PLUGIN_URL.'/admin/scripts/bb3.js', array( 'jquery' ), false, true );

	wp_enqueue_script( 'wssf-backbone-builder-script-row-view', LAULPB_PLUGIN_URL.'/admin/scripts/row-view.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-script-widget-view', LAULPB_PLUGIN_URL.'/admin/scripts/widget-view.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-script-save-page', LAULPB_PLUGIN_URL.'/admin/scripts/save-page.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-script-new-row', LAULPB_PLUGIN_URL.'/admin/scripts/new-row.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-script-side-panel', LAULPB_PLUGIN_URL.'/admin/scripts/side-panel.js', array( 'jquery' ), false, true );


	wp_enqueue_script( 'wssf-backbone-builder-script_collectionView', LAULPB_PLUGIN_URL.'/admin/scripts/pbb-CollectionView.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'wssf-backbone-builder-script-pbb-drag-n-drop', LAULPB_PLUGIN_URL.'/admin/scripts/pbb-drag-n-drop.js', array( 'jquery' ), false, true );

	
	
	wp_enqueue_style( 'wssf-backbone-builder-jqueryUI-style', LAULPB_PLUGIN_URL.'/js/Backbone-resources/jquery-ui.css' );
	wp_enqueue_style( 'wssf-adminUI-styling', LAULPB_PLUGIN_URL.'/styles/admin-style.css' );

    wp_enqueue_script( 'wssf-color-picker-script', LAULPB_PLUGIN_URL.'/js/alpha-picker.js', array( 'wp-color-picker' ), false, true );
    wp_enqueue_script( 'wssf-imgUpload-script', LAULPB_PLUGIN_URL.'/js/image-upload.js', array( 'jquery' ), false, true );
    wp_enqueue_script( 'wssf-fontPicker-script', LAULPB_PLUGIN_URL.'/js/g-font-family.js', array( 'jquery' ), false, true );
...
function wssf_custom_UI_without_metabox($post){
	...
	$screen_id = get_current_screen();
	if ($screen_id->post_type === 'ulpb_post'){
		include_once(LAULPB_PLUGIN_PATH.'/admin/views/UI/admin-ui.php');
	}
...
function ulpb_main_front_html($single_template) {
    ...
    $ulpb_template = LAULPB_PLUGIN_PATH.'public/templates/template.php';
...
function ulpb_pageBuilder_dashboard_page(){
	include_once(LAULPB_PLUGIN_PATH.'/admin/views/Dashboard/admin-dashboard.php');
}
...
function ulpb_pagebuilder_content_filter($content){
	...
	if ($ulpb_is_active == 'true') {
		include(LAULPB_PLUGIN_PATH.'public/templates/template.php');
	}else{
