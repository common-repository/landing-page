...
app.PageBuilderModel.fetch({
    ...
    $('#container').attr('style','background-image: url("'+pageBgImage+'"); background-size:cover; background-color:'+pageBgColor+'; border-right:10px solid '+pageBgColor+'; border-left:10px solid '+pageBgColor+';');
